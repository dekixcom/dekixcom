...
(function($) {
    ...
    function onSaveSettings(e) {
        ...
        ui.fetch({
            ...
            settings: JSON.stringify(ui.getFormData($form))
    ...
    function onDemoImport(e) {
        ...
        var setHomePage = Boolean($wrap.find('.fn-import-set-home-page').prop('checked'));
        var $blockEditorDataSwitch = $wrap.find('.fn-import-block-editor');
        var useBlockEditorData = $blockEditorDataSwitch.length && Boolean($blockEditorDataSwitch.prop('checked'));
        ...
        ui.fetch({
            ...
            useBlockEditorData: useBlockEditorData
    ...
    function setDemoImportControls() {
        ...
        $container.on('change', '.mkb-entities-table__header-item input[type="checkbox"]', function(e) {
            ...
            $groupInputs.attr('checked', Boolean($input.prop('checked')));
    ...
    function init() {
        ...
        ui.setupTicketsIdTool($form);
        ui.setupTestEmail($form);
