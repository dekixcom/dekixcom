...
class MKB_Search_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname' => 'mkb_search_widget mkb-widget-global',
			'description' => __('Displays KB search', 'minerva-kb' ),
		);
		parent::__construct( 'kb_search_widget', __('MinervaKB: Search', 'minerva-kb' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		MKB_TemplateHelper::render_search(array(
			...
			"search_topics" => $minerva_kb->info->is_settings_home() ? MKB_Options::option('search_topics') : '',
